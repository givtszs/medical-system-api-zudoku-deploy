import{O as i,j as n}from"./entry.client-D_RoyLeO.js";const l="Please follow the installation procedure and then run the following:",s=[{depth:2,value:"Getting Started",id:"getting-started"}],r={title:"Authorization"};function o(t){const e={a:"a",code:"code",h2:"h2",p:"p",pre:"pre",...i(),...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{id:"getting-started",children:"Getting Started"}),`
`,n.jsxs(e.p,{children:["Please follow the ",n.jsx(e.a,{href:"/docs/installation",children:"installation procedure"})," and then run the following:"]}),`
...
//# sourceMappingURL=authorization-B5w3LQTF.js.map
